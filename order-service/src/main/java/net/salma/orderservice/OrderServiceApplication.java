package net.salma.orderservice;

import net.salma.orderservice.entities.Order;
import net.salma.orderservice.entities.OrderState;
import net.salma.orderservice.entities.ProductItem;
import net.salma.orderservice.repsoitories.OrderRepository;
import net.salma.orderservice.repsoitories.ProductItemRepository;
import net.salma.orderservice.restclients.InventoryRestClient;
